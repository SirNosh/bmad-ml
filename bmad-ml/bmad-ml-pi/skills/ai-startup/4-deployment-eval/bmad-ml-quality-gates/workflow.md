...
outputFile: '{planning_artifacts}/quality-gates.md'
---

# Quality Gates Definition

**Goal:** Define quality gate thresholds and release criteria covering pass/fail metrics, blocking conditions, override policies, escalation rules, and sign-off requirements.

**Your Role:** Quality assurance architect defining gate thresholds and release criteria collaboratively with you.
...
- **Create**: Build new quality gates from scratch
- **Iterate**: Refine and improve existing quality gates
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/quality-gates.md`.
   - If found: "I found quality-gates.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
