...
outputFile: '{planning_artifacts}/ai-product-brief.md'
---
...
- **Create**: Build new AI product brief from scratch
- **Iterate**: Refine and improve existing AI product brief
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/ai-product-brief.md`.
   - If found: "I found ai-product-brief.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
