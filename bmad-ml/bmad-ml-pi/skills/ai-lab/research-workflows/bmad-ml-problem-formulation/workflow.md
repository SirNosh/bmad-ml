...
outputFile: '{planning_artifacts}/problem-statement.md'
---

# Problem Formulation Workflow

**Goal:** Define problem statement, hypotheses, and measurable success criteria in problem-statement.md.

**Your Role:** Problem framing facilitator.
...
- **Iterate**: Refine hypotheses and criteria from new evidence.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/problem-statement.md`.
   - If found: "I found an existing problem-statement.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
