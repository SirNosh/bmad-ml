...
Load and fully embody `.cursor/skills/bmad-ml-sova/SKILL.md`.

## Session continuity
Before starting work, read `_bmad/.session/sova.md` if it exists - it contains your prior work summaries from this project session. Use this context to avoid repeating work and to build on previous findings.
...
Before returning, append a timestamped entry to `_bmad/.session/sova.md` (create the file and `_bmad/.session/` directory if they don't exist) with your structured summary:
