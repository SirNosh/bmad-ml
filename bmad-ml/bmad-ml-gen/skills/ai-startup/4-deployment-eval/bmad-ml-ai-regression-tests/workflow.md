...
outputFile: '{experiment_artifacts}/regression-test-plan.md'
---

# AI Regression Test Suite

**Goal:** Create an AI regression test suite covering critical scenario identification, golden dataset curation, assertion definitions, failure thresholds, and automated run configuration.

**Your Role:** AI test engineer creating regression test suites and coverage plans collaboratively with you.
...
- **Create**: Build new regression test suite from scratch
- **Iterate**: Refine and expand existing regression test suite
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/regression-test-plan.md`.
   - If found: "I found regression-test-plan.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
