...
outputFile: '{planning_artifacts}/evaluation-report.md'
---

# AI Quality Evaluation

**Goal:** Run an AI quality evaluation benchmark covering metric selection, test set curation, baseline comparison, scoring methodology, and results analysis.

**Your Role:** AI evaluation specialist running quality benchmarks and comparative analysis collaboratively with you.
...
- **Create**: Run a new evaluation benchmark
- **Compare**: Run benchmark and compare against previous results
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/evaluation-report.md`.
   - If found: "I found evaluation-report.md (run {N}). Would you like to **Compare** (run new benchmark and compare) or **Create New** (start fresh)?"
