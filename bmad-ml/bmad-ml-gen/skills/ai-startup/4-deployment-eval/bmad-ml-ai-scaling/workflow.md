...
outputFile: '{experiment_artifacts}/scaling-plan.md'
---

# AI Scaling Strategy

**Goal:** Define a scaling strategy covering latency budgets, throughput targets, cost optimization levers, autoscaling policies, and capacity planning models.

**Your Role:** AI scaling strategist optimizing latency, throughput, and cost collaboratively with you.
...
- **Create**: Build new scaling plan from scratch
- **Iterate**: Refine and improve existing scaling plan
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/scaling-plan.md`.
   - If found: "I found scaling-plan.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
