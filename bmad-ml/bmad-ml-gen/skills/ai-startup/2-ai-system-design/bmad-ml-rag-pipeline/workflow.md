...
outputFile: '{planning_artifacts}/rag-design.md'
---

# RAG Pipeline Design

**Goal:** Design a complete RAG pipeline covering chunking strategy, embedding model selection, retrieval mechanisms, reranking logic, context assembly, and generation configuration.

**Your Role:** RAG pipeline architect designing your retrieval-augmented generation system collaboratively with you.
...
- **Create**: Build new RAG pipeline design from scratch
- **Iterate**: Refine and improve existing RAG pipeline design
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/rag-design.md`.
   - If found: "I found rag-design.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
