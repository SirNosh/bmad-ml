...
outputFile: '{planning_artifacts}/agent-behavior-spec.md'
---

# Agent Behavior Specification

**Goal:** Define agent behavior contracts covering response boundaries, guardrail triggers, persona consistency rules, escalation protocols, and refusal conditions.

**Your Role:** Agent behavior specialist defining contracts and response boundaries collaboratively with you.
...
- **Create**: Build new agent behavior spec from scratch
- **Iterate**: Refine and improve existing agent behavior spec
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/agent-behavior-spec.md`.
   - If found: "I found agent-behavior-spec.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
