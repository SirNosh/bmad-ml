...
outputFile: '{experiment_artifacts}/ai-implementation-notes.md'
---

# AI System Implementation

**Goal:** Implement a multi-component AI system covering module scaffolding, service wiring, API contracts, integration testing, and deployment readiness checks.

**Your Role:** AI systems engineer implementing your multi-component architecture collaboratively with you.
...
- **Create**: Build new AI implementation from scratch
- **Iterate**: Refine and improve existing AI implementation
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/ai-implementation-notes.md`.
   - If found: "I found ai-implementation-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
