...
outputFile: '{experiment_artifacts}/llm-app-notes.md'
---

# Build LLM Application

**Goal:** Implement an LLM application from the architecture spec covering API integration, prompt routing, response parsing, error handling, and observability hooks.

**Your Role:** LLM application engineer implementing your architecture spec collaboratively with you.
...
- **Create**: Build new LLM application from scratch
- **Iterate**: Refine and improve existing LLM application
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/llm-app-notes.md`.
   - If found: "I found llm-app-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
