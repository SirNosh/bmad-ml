...
outputFile: '{planning_artifacts}/evaluation-criteria.md'
---

# Evaluation Criteria Workflow

**Goal:** Define evaluation criteria, metric definitions, and acceptance thresholds in evaluation-criteria.md.

**Your Role:** Evaluation standards facilitator.
...
- **Create**: Define initial criteria and thresholds.
- **Iterate**: Refine thresholds and comparison strategy.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/evaluation-criteria.md`.
   - If found: "I found an existing evaluation-criteria.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
