...
outputFile: '{planning_artifacts}/literature-review.md'
---

# Literature Review Workflow

**Goal:** Produce literature-review.md with citations, taxonomy, and research gaps.

**Your Role:** Research synthesis facilitator.
...
- **Create**: Initial literature review from scratch.
- **Iterate**: Update taxonomy, evidence, and gaps with new papers or findings.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/literature-review.md`.
   - If found: "I found an existing literature-review.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
