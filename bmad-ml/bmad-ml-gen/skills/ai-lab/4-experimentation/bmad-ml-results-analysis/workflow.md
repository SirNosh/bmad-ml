...
outputFile: '{planning_artifacts}/results-report.md'
---

# Results Analysis Workflow

**Goal:** Analyze experiment results and produce results-report.md with metric interpretation, comparisons, and recommendations.

**Your Role:** Results interpretation facilitator.
...
- **Create**: Initial results report.
- **Compare**: Side-by-side analysis across experiment iterations.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/results-report.md`.
   - If found: "I found an existing results-report.md (iteration {N}). Would you like to **Compare** (side-by-side with a new analysis) or **Create New** (start fresh)?"
