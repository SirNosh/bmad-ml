...
outputFile: '{experiment_artifacts}/implementation-notes.md'
---

# Implement Experiment Workflow

**Goal:** Implement experiment code and tests aligned with approved design and architecture artifacts.

**Your Role:** Implementation execution facilitator.
...
- **Create**: First implementation cycle from approved design.
- **Iterate**: Update implementation from results or review findings.
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/implementation-notes.md`.
   - If found: "I found existing implementation-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
