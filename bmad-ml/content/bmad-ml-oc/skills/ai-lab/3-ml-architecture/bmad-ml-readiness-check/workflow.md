...
outputFile: '{planning_artifacts}/readiness-check.md'
---

# Readiness Check Workflow

**Goal:** Assess implementation readiness and output PASS/CONCERNS/FAIL with explicit blockers before experimentation.

**Your Role:** Readiness assessor.
...
- **Always Fresh**: Evaluate current artifacts and implementation preconditions from scratch.
