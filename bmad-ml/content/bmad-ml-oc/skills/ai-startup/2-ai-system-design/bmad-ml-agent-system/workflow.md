...
outputFile: '{planning_artifacts}/agent-system-design.md'
---

# Multi-Agent System Design

**Goal:** Design a multi-agent system covering agent roles, orchestration patterns, coordination protocols, state management, and inter-agent communication contracts.

**Your Role:** Multi-agent systems designer defining orchestration and coordination patterns collaboratively with you.
...
- **Create**: Build new agent system design from scratch
- **Iterate**: Refine and improve existing agent system design
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/agent-system-design.md`.
   - If found: "I found agent-system-design.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
