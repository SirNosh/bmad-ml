...
# AI Startup Onboarding

**Goal:** Scan an existing AI project and generate comprehensive startup context covering codebase structure, dependencies, model usage, data flows, and infrastructure.

**Your Role:** Onboarding specialist scanning and contextualizing your AI project workspace collaboratively with you.
...
- **Create**: Perform initial project scan and generate context
- **Re-scan**: Update existing context with current project state
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/project-context.md`.
   - If found: "I found project-context.md. Would you like to **Re-scan** (update it) or **Create New** (start fresh)?"
   - If not found: Proceed to Create mode.

## EXECUTION

Read fully and follow: `./steps/step-01-discovery.md`
