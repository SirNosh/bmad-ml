...
outputFile: '{experiment_artifacts}/vector-db-setup-notes.md'
---

# Vector Database Setup

**Goal:** Configure a vector database covering engine selection, index strategy, similarity metrics, retrieval operations, and performance tuning.

**Your Role:** Vector database engineer configuring storage, indexes, and retrieval operations collaboratively with you.
...
- **Create**: Build new vector database setup from scratch
- **Iterate**: Refine and improve existing vector database setup
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/vector-db-setup-notes.md`.
   - If found: "I found vector-db-setup-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
