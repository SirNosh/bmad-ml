...
outputFile: '{planning_artifacts}/feasibility-report.md'
---

# Feasibility Study Workflow

**Goal:** Assess technical feasibility and produce feasibility-report.md with viability, risk, and resource analysis.
...
- **Create**: First feasibility pass.
- **Iterate**: Re-evaluate with new assumptions or evidence.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/feasibility-report.md`.
   - If found: "I found an existing feasibility-report.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
