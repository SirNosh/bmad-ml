...
outputFile: '{planning_artifacts}/code-review.md'
---

# Code Review Workflow

**Goal:** Validate correctness, reproducibility, and quality of ML implementation before merge or next iteration.

**Your Role:** Standard ML code review facilitator.
...
- **Always Fresh**: Evaluate current implementation and evidence from scratch.
