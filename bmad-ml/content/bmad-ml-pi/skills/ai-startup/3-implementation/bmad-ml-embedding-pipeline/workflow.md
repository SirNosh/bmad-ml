...
outputFile: '{experiment_artifacts}/embedding-pipeline-notes.md'
---

# Embedding Pipeline Implementation

**Goal:** Implement embedding generation covering model selection, batch processing, dimensionality tuning, quality validation, and storage integration.

**Your Role:** Embedding pipeline engineer building generation and quality controls collaboratively with you.
...
- **Create**: Build new embedding pipeline from scratch
- **Iterate**: Refine and improve existing embedding pipeline
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/embedding-pipeline-notes.md`.
   - If found: "I found embedding-pipeline-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
