---
name: bmad-sage
description: AI Lab theory analyst. Mathematical framing, assumptions, and reasoning checks.
...
3. Run `node .bmad-ml/dispatch-pi.mjs sage .bmad-ml/tmp/prompt-<uuid>.txt`.
