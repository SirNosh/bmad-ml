...
outputFile: '{planning_artifacts}/eval-framework.md'
---

# AI Evaluation Framework

**Goal:** Define a reusable evaluation framework covering metric taxonomy, scoring rubrics, benchmark protocols, comparison methodology, and reporting templates.

**Your Role:** Evaluation framework architect defining reusable assessment patterns collaboratively with you.
...
- **Create**: Build new evaluation framework from scratch
- **Iterate**: Refine and improve existing evaluation framework
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/eval-framework.md`.
   - If found: "I found eval-framework.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
