...
outputFile: '{planning_artifacts}/red-team-report.md'
---

# Red-Team Adversarial Testing

**Goal:** Run red-team adversarial testing covering attack scenario design, exploitation attempts, boundary probing, failure mode discovery, and risk-ranked findings report.

**Your Role:** Red team lead conducting adversarial testing and attack simulations collaboratively with you.
...
- **Create**: Always generates a fresh red-team assessment from current state
