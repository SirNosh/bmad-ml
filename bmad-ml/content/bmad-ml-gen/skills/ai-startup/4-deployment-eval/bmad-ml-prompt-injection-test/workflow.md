...
outputFile: '{planning_artifacts}/prompt-injection-report.md'
---

# Prompt Injection Testing

**Goal:** Test prompt injection resistance covering attack vector cataloging, injection payload generation, boundary testing, bypass detection, and vulnerability scoring.

**Your Role:** Prompt security tester assessing injection resistance and vulnerabilities collaboratively with you.
...
- **Create**: Always generates a fresh prompt injection test from current state
...
2. Proceed directly to Create mode. This workflow always generates a fresh test.
