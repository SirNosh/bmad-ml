...
outputFile: '{planning_artifacts}/ai-architecture.md'
---
...
- **Create**: Build new AI architecture from scratch
- **Iterate**: Refine and improve existing AI architecture
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/ai-architecture.md`.
   - If found: "I found ai-architecture.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
