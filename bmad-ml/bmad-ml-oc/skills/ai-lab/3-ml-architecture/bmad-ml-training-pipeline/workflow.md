...
outputFile: '{planning_artifacts}/training-pipeline.md'
---

# Training Pipeline Workflow

**Goal:** Produce training-pipeline.md for reproducible, efficient training execution.

**Your Role:** Pipeline design facilitator.
...
- **Create**: Define initial pipeline specification.
- **Iterate**: Refine for reliability, throughput, or new requirements.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/training-pipeline.md`.
   - If found: "I found an existing training-pipeline.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
