...
outputFile: '{planning_artifacts}/adversarial-review.md'
---

# Adversarial Review Workflow

**Goal:** Stress-test claims and identify confounders, weak evidence, or invalid conclusions.

**Your Role:** Adversarial review facilitator.
...
- **Always Fresh**: Evaluate current claims and experiment evidence from scratch.
