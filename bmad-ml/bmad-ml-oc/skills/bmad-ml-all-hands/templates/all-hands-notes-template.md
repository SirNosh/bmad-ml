...
|---|-------|------|----------|-----------|----------|
| 1 | {topic} | {decision / discussion / informational} | {minutes} | {agent/person} | {link to artifact, if any} |
...
> **Purpose:** Record who participated so that decisions have clear accountability and absent stakeholders can be informed.
> **Guidance:** Include agents from both the AI Lab and AI Startup divisions as relevant. Note each attendee's primary role in this meeting.

| Agent / Person | Division | Role in Meeting | Present? |
|---------------|----------|----------------|----------|
| {name} | {AI Lab / AI Startup / Both} | {e.g., presenter, reviewer, decision-maker} | {yes/no} |
| {name} | {division} | {role} | {yes/no} |
| {name} | {division} | {role} | {yes/no} |
...
| Field | Value |
|-------|-------|
| **Meeting Type** | {direction-setting / status-review / retrospective / emergency} |
| **Cadence** | {e.g., weekly, ad-hoc, iteration boundary} |
| **Decision Protocol** | {e.g., consensus, PI decides, majority vote} |
| **Notes Taken By** | {agent/person} |
...
1. {e.g., "Nosh begins experiment runs per approved design by Wednesday."}
2. {e.g., "Mae completes literature review update by Friday."}
3. {next step}
...
> **Guidance:** Items here should be added to the next meeting's agenda or assigned for async resolution.

| # | Topic | Raised By | Priority | Disposition |
|---|-------|----------|----------|------------|
| 1 | {topic} | {agent} | {high/medium/low} | {next meeting / async / deferred} |
