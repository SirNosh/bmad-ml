...
outputFile: '{experiment_artifacts}/ai-cicd-notes.md'
---

# AI CI/CD Pipeline Design

**Goal:** Design a CI/CD pipeline for AI artifacts covering build triggers, model validation gates, artifact versioning, staging promotion, and automated rollback rules.

**Your Role:** AI DevOps engineer designing your CI/CD pipeline for AI artifacts collaboratively with you.
...
- **Create**: Build new AI CI/CD pipeline from scratch
- **Iterate**: Refine and improve existing AI CI/CD pipeline
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/ai-cicd-notes.md`.
   - If found: "I found ai-cicd-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
