...
outputFile: '{experiment_artifacts}/fine-tuning-report.md'
---

# Fine-Tuning Pipeline

**Goal:** Build a fine-tuning pipeline covering dataset preparation, training configuration, hyperparameter selection, checkpoint management, and evaluation harness.

**Your Role:** Fine-tuning engineer building your training pipeline and evaluation harness collaboratively with you.
...
- **Create**: Build new fine-tuning pipeline from scratch
- **Iterate**: Refine and improve existing fine-tuning pipeline
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/fine-tuning-report.md`.
   - If found: "I found fine-tuning-report.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
