...
outputFile: '{experiment_artifacts}/quick-prototype-notes.md'
---

# Quick AI Prototype

**Goal:** Build a time-boxed prototype for rapid validation covering scope definition, minimal viable integration, quick evaluation, and go/no-go decision support.

**Your Role:** Rapid prototyping engineer building a time-boxed validation prototype collaboratively with you.
...
- **Create**: Build new prototype from scratch
...
2. Proceed to Create mode. This workflow always starts fresh.
