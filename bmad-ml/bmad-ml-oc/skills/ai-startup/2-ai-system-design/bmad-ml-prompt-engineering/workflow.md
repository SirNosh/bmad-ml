...
outputFile: '{planning_artifacts}/prompt-spec.md'
---

# Prompt Engineering Strategy

**Goal:** Design a comprehensive prompt strategy covering template structures, variable injection patterns, chain-of-thought scaffolding, and an iteration plan for refinement.

**Your Role:** Prompt engineering specialist crafting your prompt strategy and templates collaboratively with you.
...
- **Create**: Build new prompt spec from scratch
- **Iterate**: Refine and improve existing prompt spec
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/prompt-spec.md`.
   - If found: "I found prompt-spec.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
