...
outputFile: '{planning_artifacts}/ai-readiness-check.md'
---

# AI Readiness Check

**Goal:** Assess readiness for AI implementation by evaluating architecture completeness, data availability, infrastructure preparedness, team capacity, and risk coverage.

**Your Role:** Readiness assessor evaluating your AI system's implementation preparedness collaboratively with you.
...
- **Create**: Always generates a fresh readiness assessment from current state
...
2. Proceed directly to Create mode. This workflow always generates a fresh assessment.
