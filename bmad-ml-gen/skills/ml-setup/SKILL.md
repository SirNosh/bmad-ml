...
- If `{project-root}/.claude/` exists → offer to create or append `{project-root}/CLAUDE.md` using `./assets/claude-md-snippet.md`, resolving config tokens
- If `{project-root}/.cursor/` exists → offer to create or append `{project-root}/.cursorrules` using `./assets/cursorrules-snippet.md`, resolving config tokens
...
- If multiple exist, offer all that apply
- If the target file already exists and contains "bmad-ml" or "BMad ML", skip with a note that it is already configured
