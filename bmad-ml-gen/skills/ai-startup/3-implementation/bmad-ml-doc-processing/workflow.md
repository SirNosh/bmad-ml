...
outputFile: '{experiment_artifacts}/doc-processing-notes.md'
---

# Document Processing Pipeline

**Goal:** Implement a document ingestion and processing pipeline covering format parsing, content extraction, metadata tagging, chunking strategy, and quality validation.

**Your Role:** Document processing engineer building your ingestion and extraction pipeline collaboratively with you.
...
- **Create**: Build new document processing pipeline from scratch
- **Iterate**: Refine and improve existing document processing pipeline
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/doc-processing-notes.md`.
   - If found: "I found doc-processing-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
