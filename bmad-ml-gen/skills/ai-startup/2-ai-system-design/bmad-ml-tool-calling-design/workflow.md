...
outputFile: '{planning_artifacts}/tool-schemas.json'
---

# Tool Calling Design

**Goal:** Define tool schemas, function calling contracts, parameter validation rules, invocation safety constraints, and error handling patterns for LLM tool use.

**Your Role:** Tool integration architect defining schemas and safety contracts collaboratively with you.
...
- **Create**: Build new tool schemas from scratch
- **Iterate**: Refine and improve existing tool schemas
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/tool-schemas.json`.
   - If found: "I found tool-schemas.json (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
