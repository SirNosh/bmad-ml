...
outputFile: '{planning_artifacts}/ai-ux-spec.md'
---

# AI UX Design

**Goal:** Design AI interaction patterns covering conversational flows, feedback mechanisms, confidence display, fallback behaviors, and UX safeguards for AI-driven interfaces.

**Your Role:** AI UX designer crafting interaction patterns and safeguards collaboratively with you.
...
- **Create**: Build new AI UX spec from scratch
- **Iterate**: Refine and improve existing AI UX spec
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/ai-ux-spec.md`.
   - If found: "I found ai-ux-spec.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
