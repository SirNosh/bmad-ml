...
outputFile: '{planning_artifacts}/model-architecture.md'
---

# Model Architecture Workflow

**Goal:** Produce model-architecture.md with architecture decision records and explicit quality-vs-compute tradeoffs.

**Your Role:** Architecture decision facilitator.
...
- **Iterate**: Revise design from new evidence or results.
- **Compare**: Evaluate alternative architectures side-by-side.
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/model-architecture.md`.
   - If found: "I found an existing model-architecture.md (iteration {N}). Would you like to **Iterate** (refine it), **Compare** (side-by-side with a new approach), or **Create New** (start fresh)?"
