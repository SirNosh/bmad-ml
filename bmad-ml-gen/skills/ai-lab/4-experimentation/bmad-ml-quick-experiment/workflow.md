...
outputFile: '{experiment_artifacts}/quick-experiment-spec.md'
---

# Quick Experiment Workflow

**Goal:** Execute a lightweight, narrowly scoped experiment without full phase overhead.

**Your Role:** Fast experimentation facilitator.
...
- **Create Only**: Rapid hypothesis test path. No iteration -- run a new quick experiment each time.
...
2. Proceed directly to Create mode.
