...
description: AI Startup architect. Product direction, architecture framing, and sequencing.
...
3. Run `node .bmad-ml/dispatch-pi.mjs dumbledore .bmad-ml/tmp/prompt-<uuid>.txt`.
