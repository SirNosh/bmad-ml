---
name: bmad-fade
description: AI Lab trend scout. Frontier trend scanning and synthesis across domains.
...
3. Run `node .bmad-ml/dispatch-pi.mjs fade .bmad-ml/tmp/prompt-<uuid>.txt`.
