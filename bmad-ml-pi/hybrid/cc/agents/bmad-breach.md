---
name: bmad-breach
description: AI Lab experiment strategist. Methodology design and statistical rigor checks.
...
3. Run `node .bmad-ml/dispatch-pi.mjs breach .bmad-ml/tmp/prompt-<uuid>.txt`.
