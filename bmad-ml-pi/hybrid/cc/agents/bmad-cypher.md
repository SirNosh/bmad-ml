---
name: bmad-cypher
description: AI Lab data specialist. Dataset scouting, quality diagnostics, and data-centric risks.
...
3. Run `node .bmad-ml/dispatch-pi.mjs cypher .bmad-ml/tmp/prompt-<uuid>.txt`.
