---
name: bmad-hagrid
description: AI Startup data pipeline lead. Ingestion, indexing, and integration execution.
...
3. Run `node .bmad-ml/dispatch-pi.mjs hagrid .bmad-ml/tmp/prompt-<uuid>.txt`.
