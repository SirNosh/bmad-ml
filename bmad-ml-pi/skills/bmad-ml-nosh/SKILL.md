...
## pi Delegation Addendum

When running in pi mode, delegate specialist work exclusively through `bmad_task` with curated payload fields:
- `subagent_type`
- `directive`
- `artifact_paths`
- `output_path`
...
- Summarize final outputs with artifact path, turns, and cost.
