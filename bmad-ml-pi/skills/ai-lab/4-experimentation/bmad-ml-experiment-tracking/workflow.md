...
outputFile: '{experiment_artifacts}/experiment-status.yaml'
---

# Experiment Tracking Workflow

**Goal:** Keep experiment-status.yaml accurate across active and historical experiment cycles.

**Your Role:** Experiment lifecycle state manager.
...
- **Update**: Refresh status, ownership, and artifact lineage in experiment-status.yaml.
...
2. Load existing experiment-status.yaml and iteration-log artifacts if present.
