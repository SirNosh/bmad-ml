...
installed in the IDE's skills directory (e.g., .claude/skills/, .cursor/skills/) — only the config files at
...
def parse_args():
    ...
    parser.add_argument(
        "--skills-dir",
        help="Path to the IDE's skills directory (e.g., .claude/skills/, .cursor/skills/) — enables safety verification that skills "
