...
5. Optionally, accept the prompt to append a bmad-ml section to `AGENTS.md` (OpenCode), `CLAUDE.md`, or `.cursorrules`
...
- **Claude Code**: `CLAUDE.md` at project root -- loaded automatically on every conversation
- **Cursor**: `.cursorrules` at project root -- loaded automatically as context
