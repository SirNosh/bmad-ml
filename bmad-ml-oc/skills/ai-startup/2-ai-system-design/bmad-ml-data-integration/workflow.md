...
outputFile: '{planning_artifacts}/data-integration.md'
---

# Data Integration Architecture

**Goal:** Design the data ingestion and integration architecture covering source connectors, transformation pipelines, schema mapping, quality validation, and data flow orchestration.

**Your Role:** Data integration architect designing ingestion and pipeline architecture collaboratively with you.
...
- **Create**: Build new data integration design from scratch
- **Iterate**: Refine and improve existing data integration design
...
2. **Iteration Check:** Search for existing artifact at `{planning_artifacts}/data-integration.md`.
   - If found: "I found data-integration.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
