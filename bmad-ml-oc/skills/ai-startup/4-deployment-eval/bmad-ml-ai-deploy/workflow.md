...
outputFile: '{experiment_artifacts}/deployment-notes.md'
---

# AI System Deployment

**Goal:** Deploy an AI system covering environment provisioning, model serving configuration, runbook creation, rollback procedures, and health check verification.

**Your Role:** AI deployment engineer managing your system rollout and runbook collaboratively with you.
...
- **Create**: Build new deployment plan from scratch
- **Iterate**: Refine and improve existing deployment plan
...
2. **Iteration Check:** Search for existing artifact at `{experiment_artifacts}/deployment-notes.md`.
   - If found: "I found deployment-notes.md (iteration {N}). Would you like to **Iterate** (refine it) or **Create New** (start fresh)?"
